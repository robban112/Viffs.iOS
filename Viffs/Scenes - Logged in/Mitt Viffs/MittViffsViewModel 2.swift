  ...
  init(coordinator: SceneCoordinator) {
    receiptCollectionsContents = Driver.just([
      ReceiptCollection(
        ...
        scene: Scene.receipts(FilterParameters(cards: Current.cards, filterByUserUpload: false))
      ),
      ReceiptCollection(
        name: "Importerat",
        logo: UIImage(named: "Imported-green-2")!,
        scene: Scene.receipts(FilterParameters.init(cards: [], filterByUserUpload: false))
      ),
      ReceiptCollection(
        name: "Scannat",
        logo: UIImage(named: "Scanned-green-2")!,
        scene: Scene.receipts(FilterParameters.init(cards: Current.cards, filterByUserUpload: true))
      ),
      ReceiptCollection(
        name: "Butiker",
